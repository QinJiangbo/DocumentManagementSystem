...
<div class="content">
	...
	<div class="position">
		<span>当前位置：</span><span><a href="UserServlet?act=index">首页</a></span>&gt;<span><a
			href="TechnologyEssayServlet?op=query">技术文献查询</a></span>
	</div>
	<form action="TechnologyEssayServlet?op=query"
		method="post">
			...
			<tbody>
				<c:forEach items="${rows }" var="row">
					<tr>
						...
						<td class="col3_operation"><a onclick="javascript:urlEncode2('TechnologyEssayServlet?op=query&ch=view&id=${row['编号'] }&method=init&projectType=技术文献&projectId=${row['名称']}')" target="_blank">查看</a></td>
					</tr>
				</c:forEach>
			</tbody>
		</table>
