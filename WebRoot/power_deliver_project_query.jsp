...
<div class="content">
	...
	<div class="position">
		<span>当前位置：</span><span><a href="UserServlet?act=index">首页</a></span>&gt;<span><a
			href="PowerDeliverProjectServlet?op=query">送电工程项目查询</a></span>
	</div>
	<form action="PowerDeliverProjectServlet?op=query"
		method="post">
		...
		<div class="fuel_machine_project_input_container">
			<div class="project_input_item_left">
				<div class="project_input_item_container">
					...
					<div class="fuel_machine_project_input">
						<select name="line_voltage_level" class="input_select">
							<option value=""></option>
			...
			<div class="project_input_item_right">
				<div class="project_input_item_container">
					...
					<div class="fuel_machine_project_input">
						<select name="design_wind_speed" class="input_select">
							<option value=""></option>
		...
		<div class="fuel_machine_project_input_container">
			<div class="project_input_item_left">
				<div class="project_input_item_container">
					...
					<div class="fuel_machine_project_input">
						<select name="icing_thickness" class="input_select">
							<option value=""></option>
			...
			<div class="project_input_item_right">
				<div class="project_input_item_container">
					...
					<div class="fuel_machine_project_input">
						<select name="landform" class="input_select">
							<option value=""></option>
		...
		<div class="fuel_machine_project_input_container">
			<div class="project_input_item_left">
				<div class="project_input_item_container">
					...
					<div class="fuel_machine_project_input">
						<select name="wire_pattern" class="input_select">
							<option value=""></option>
			...
			<div class="project_input_item_right">
				<div class="project_input_item_container">
					...
					<div class="fuel_machine_project_input">
						<select name="wire_divide_number" class="input_select">
							<option value=""></option>
		...
		<div class="fuel_machine_project_input_container">
			<div class="project_input_item_left">
				<div class="project_input_item_container">
					...
					<div class="fuel_machine_project_input">
						<select name="wire_cross_section" class="input_select">
							<option value=""></option>
			...
			<div class="project_input_item_right">
				<div class="project_input_item_container">
					...
					<div class="fuel_machine_project_input">
						<select name="loop_numbers" class="input_select">
							<option value=""></option>
			...
			<tbody>
				<c:forEach items="${rows }" var="row">
					<tr>
						...
						<td class="col4"><a onclick="javascript:urlEncode2('PowerDeliverProjectServlet?op=query&ch=view&id=${row['编号']}&method=init&projectType=送电工程项目&projectId=${row['项目编号']}')" target="_blank">查看</a></td>
					</tr>
				</c:forEach>
			</tbody>
		</table>
