...
${msg}
	<div class="position">
		<span>当前位置：</span><span><a href="UserServlet?act=index">首页</a></span>&gt;<span><a href="PowerTransferEngineeringProjectServlet?op=insert">变电工程项目录入</a></span>
	</div>
	<form action="PowerTransferEngineeringProjectServlet?op=add" method="post" onsubmit="return pidCheck()">
	...
	<div class="fuel_machine_project_input_container">
		...
		<div class="project_input_item_right">
			<div class="project_input_item_container">
				...
				</span><span class="mixed_right_input"><input type="text" name="power_transfer_type" value="${powerTransferTypeRow }" /></span>
				</div>
			</div>
		</div>
	</div>
	<div class="fuel_machine_project_input_container">
		<div class="project_input_item_left">
			<div class="project_input_item_container">
				...
				</span><span class="mixed_left_input"><input type="number" name="single_main_transformation_capacity" value="${singleMainTransformationCapacityRow }" /></span>
				</div>
			</div>
		</div>
		<div class="project_input_item_right">
			<div class="project_input_item_container">
				...
				</span><span class="mixed_right_input"><input type="number" name="main_transformation_number" value="${mainTransformationNumberRow }" /></span>
				</div>
			</div>
		</div>
	</div>
	<div class="fuel_machine_project_input_container">
		<div class="project_input_item_left">
			<div class="project_input_item_container">
				...
				</span><span class="mixed_left_input"><input type="number" name="main_transformation_primary_side_voltage" value="${mainTransformationPrimarySideVoltageRow }" /></span>
				</div>
			</div>
		</div>
		<div class="project_input_item_right">
			<div class="project_input_item_container">
				...
				</span><span class="mixed_right_input"><input type="number" name="main_transformation_second_side_voltage" value="${mainTransformationSecondSideVoltageRow }" /></span>
				</div>
			</div>
		</div>
	</div>
	<div class="fuel_machine_project_input_container">
		<div class="project_input_item_left">
			<div class="project_input_item_container">
				...
				</span><span class="mixed_left_input"><input type="number" name="main_transformation_third_winding_voltage" value="${mainTransformationThirdWindingVoltageRow }" /></span>
				</div>
			</div>
		</div>
		<div class="project_input_item_right">
			<div class="project_input_item_container">
				...
				</span><span class="mixed_right_input"><input type="text" name="main_transformation_primary_side_voltage_power_distribution_main_wire" value="${mainTransformationPrimarySideVoltagePowerDistributionMainWireRow }" /></span>
				</div>
			</div>
		</div>
	</div>
	<div class="fuel_machine_project_input_container">
			<div class="project_input_item_left">
				...
				</span><span class="mixed_left_input"><input type="text" name="main_transformation_second_side_voltage_power_distribution_main_wire" value="${mainTransformationSecondSideVoltagePowerDistributionMainWireRow }" /></span>
				</div>
				</div>
			</div>
			<div class="project_input_item_right">
			<div class="project_input_item_container">
				<div class="fuel_machine_project_input_label">主变第三绕组侧电压配电装置电气主接线 ：</div>
				<div class="mixed_input_container">
				<span class="mixed_right_select">
					<select onchange="this.parentNode.nextSibling.firstChild.value=this.value">
						<option value=""></option>
				...
				</span><span class="mixed_right_input"><input type="text" name="main_transformation_third_winding_voltage_power_distribution_main_wire" value="${mainTransformationThirdWindingVoltagePowerDistributionMainWireRow }" /></span>
				</div>
			</div>
		</div>
	</div>
	<div class="fuel_machine_project_input_container">
		<div class="project_input_item_left">
			<div class="project_input_item_container">
				...
				</span><span class="mixed_left_input"><input type="text" name="main_transformation_primary_side_voltage_power_distribution_pattern" value="${mainTransformationPrimarySideVoltagePowerDistributionPatternRow }" /></span>
				</div>
			</div>
		</div>
		<div class="project_input_item_right">
			<div class="project_input_item_container">
				...
				</span><span class="mixed_right_input"><input type="text" name="main_transformation_second_side_voltage_power_distribution_pattern" value="${mainTransformationSecondSideVoltagePowerDistributionPatternRow }" /></span>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="fuel_machine_project_input_container">
		<div class="project_input_item_left">
			<div class="project_input_item_container">
				...
				</span><span class="mixed_left_input"><input type="text" name="main_transformation_third_winding_voltage_power_distribution_pattern" value="${mainTransformationThirdWindingVoltagePowerDistributionPatternRow }" /></span>
				</div>
			</div>
		</div>
		<c:choose>
	...
	<div class="query_table_area">
									...
									<tr>
										...
										<c:choose>
											<c:when test="${op=='query'||op=='view' }">
												<a onclick="javascript:urlEncode('PowerTransferEngineeringProjectServlet?op=query&ch=${op}&id=${ idRow }&method=checkSubFiles&path=${ myFile.filePath }')">打开下级目录</a>		
											</c:when>
											<c:when test="${op=='verify' }">
												<a onclick="javascript:urlEncode('PowerTransferEngineeringProjectServlet?op=verify&ch=${ idRow }&method=checkSubFiles&path=${ myFile.filePath }')">打开下级目录</a>
											</c:when>
											<c:when test="${ch=='unpass' }">
												<a onclick="javascript:urlEncode('PowerTransferEngineeringProjectServlet?op=update&ch=unpass&id=${ idRow }&method=checkSubFiles&path=${ myFile.filePath }')">打开下级目录</a>
											</c:when>
											<c:when test="${op=='maintenance' }">
												<a onclick="javascript:urlEncode('PowerTransferEngineeringProjectServlet?op=maintenance&id=${ idRow }&ch=open&method=checkSubFiles&path=${ myFile.filePath }')">打开下级目录</a>
											</c:when>
		...
		<div class="download_menu">
			...
			<c:choose>
				...
				<c:choose>
					<c:when test="${op=='query'||op=='view' }">	
					<a class="btn btn-default back_to_parent_btn" disabled onclick="javascript:urlEncode('PowerTransferEngineeringProjectServlet?op=query&ch=${op}&id=${ idRow }&method=checkParentFolder&currentPath=${ currentPath }')">返回上一级目录</a>
					</c:when>
					<c:when test="${op=='verify' }">
					<a class="btn btn-default back_to_parent_btn" disabled onclick="javascript:urlEncode('PowerTransferEngineeringProjectServlet?op=verify&ch=${ idRow }&method=checkParentFolder&currentPath=${ currentPath }')">返回上一级目录</a>
					</c:when>
					<c:when test="${ch=='unpass' }">
					<a class="btn btn-default back_to_parent_btn" disabled onclick="javascript:urlEncode('PowerTransferEngineeringProjectServlet?op=update&ch=unpass&id=${ idRow }&method=checkParentFolder&currentPath=${ currentPath }')">返回上一级目录</a>
					</c:when>
					<c:when test="${op=='maintenance' }">
					<a class="btn btn-default back_to_parent_btn" disabled onclick="javascript:urlEncode('PowerTransferEngineeringProjectServlet?op=maintenance&ch=open&id=${ idRow }&method=checkParentFolder&currentPath=${ currentPath }')">返回上一级目录</a>
					</c:when>
					<c:otherwise></c:otherwise>
				</c:choose>
				</c:when>
				<c:otherwise>
					<c:choose>
					<c:when test="${op=='query'||op=='view' }">	
					<a class="btn btn-default back_to_parent_btn" onclick="javascript:urlEncode('PowerTransferEngineeringProjectServlet?op=query&ch=${op}&id=${ idRow }&method=checkParentFolder&currentPath=${ currentPath }')">返回上一级目录</a>
					</c:when>
					<c:when test="${op=='verify' }">
					<a class="btn btn-default back_to_parent_btn" onclick="javascript:urlEncode('PowerTransferEngineeringProjectServlet?op=verify&ch=${ idRow }&method=checkParentFolder&currentPath=${ currentPath }')">返回上一级目录</a>
					</c:when>
					<c:when test="${ch=='unpass' }">
					<a class="btn btn-default back_to_parent_btn" onclick="javascript:urlEncode('PowerTransferEngineeringProjectServlet?op=update&ch=unpass&id=${ idRow }&method=checkParentFolder&currentPath=${ currentPath }')">返回上一级目录</a>
					</c:when>
					<c:when test="${op=='maintenance' }">
					<a class="btn btn-default back_to_parent_btn" onclick="javascript:urlEncode('PowerTransferEngineeringProjectServlet?op=maintenance&ch=open&id=${ idRow }&method=checkParentFolder&currentPath=${ currentPath }')">返回上一级目录</a>
					</c:when>
					<c:otherwise></c:otherwise>
				</c:choose>
				</c:otherwise>
