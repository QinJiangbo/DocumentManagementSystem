...
${msg}
	<div class="position">
		<span>当前位置：</span><span><a href="UserServlet?act=index">首页</a></span>&gt;<span><a href="project_expert_query.jsp">工程专家查询</a></span>
	</div>
	<form action="ProjectExpertServlet?op=query" method="post">
	<div class="fuel_machine_project_input_container">
		...
		<div class="project_input_item_right">
			<div class="project_input_item_container">
				...
				<div class="fuel_machine_project_input"><input type="text" name="profession" /></div>
			</div>
		</div>
	</div>
	<div class="fuel_machine_project_input_container">
		<div class="project_input_item_left">
			<div class="project_input_item_container">
				...
				<div class="fuel_machine_project_input">
						<select name="education_background" class="input_select">
							<option value=""></option>
			...
			<tbody>
				<c:forEach items="${rows }" var="row">
					<tr>
						...
						<td class="col4"><a onclick="javascript:urlEncode2('ProjectExpertServlet?op=query&ch=view&id=${row['编号'] }&method=init&projectType=工程专家&projectId=${row['身份证']}')" target="_blank">查看</a></td>
					</tr>
				</c:forEach>
			</tbody>
		</table>
