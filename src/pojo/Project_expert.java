...
public class Project_expert {
	...
	public void setIdentified_card(String identified_card) {
		if(identified_card==null){
			this.identified_card = "";
		}
		else {
			this.identified_card = identified_card;
		}
	}
	...
	public void setMain_performance(String main_performance) {
		if(main_performance==null){
			this.main_performance = "";
		}
		else {
			this.main_performance = main_performance;
		}
	}
